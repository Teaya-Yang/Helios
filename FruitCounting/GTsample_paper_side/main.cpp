...
using namespace std;
  ...
  int main( void ){
     ...
     // string resultstextname = "outputs/results_left.txt";
     string resultstextname = "outputs/results_right_short.txt";
     ...
     // string name_file = "inputs/LeftPicNames.txt";
     string name_file = "inputs/RightPicNamesShort.txt";
     ...
     for (int icam = 0; icam < samplePos_array.size(); icam++){
          ...
          for (int i_tree = 0; i_tree < 8; i_tree++){
               ...
               for (int i = 0; i<raydir.size(); i++){
                    ...
                    /*No need to check for trees in front*/
                    int i_check = i_tree;
